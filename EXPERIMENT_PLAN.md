...
The data-management documents, project-record templates, empty registry, first-slice package with three tasks and all five conditions, evidence projections, and scoring utilities exist now. The remaining paths describe the later local implementation and generated outputs.
